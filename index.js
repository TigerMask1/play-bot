      ...
      case 'systems':
        const overviewEmbed = new EmbedBuilder()
          ...
          .addFields(
            ...
            { name: '🎁 Drop System **[PAID MODEL]**', value: '**Non-main servers:** ZooAdmins pay 100 gems for 3 hours of drops. Auto-pauses after 30 uncaught drops (timer keeps running). Anyone can revive drops by using `!c <code>` - even if they don\'t catch it or own the character!\n**Main server:** Unlimited free drops!' },
