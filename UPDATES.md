...
- `!bpclaim <tier>` - Claim a specific tier's rewards
- `!bpclaim all` - Claim all available tier rewards
- `!bpseason start <number>` - (Super Admin) Start a new season
- `!bpseason info` - View current season information
...
**Commands:**
- `!emotes` or `!myemotes` - View your emote collection
- `!setemote <name>` - Set your active profile emote
- `!setemote none` - Clear your profile emote
- `!uploademote <name>` - (Super Admin) Upload a new emote (attach image)
- `!grantemote @user <name>` - (Super Admin) Grant an emote to a user
- `!deleteemote <name>` - (Super Admin) Delete an emote from the system
...
- `!resetnickname <character>` or `!clearnick` - Remove a character's nickname
